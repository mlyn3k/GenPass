class PasswordGenerator {
    ...
    getRandomLowercase() { //od 97 do 120 w ASCII
        return String.fromCharCode(97 + Math.floor(Math.random()*26));
    }

    getRandomNumber() {
        return Math.floor(Math.random()*10); //ponieważ liczby między 1-9
    }
    ...
    copyToClipboard = () => {
        ...
        cb.writeText(v).then( () => console.log(`Hasło skopiowane do schowka ${v}`));
    }
